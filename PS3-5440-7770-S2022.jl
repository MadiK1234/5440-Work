...
# ╔═╡ 12b46b34-cddc-4ccb-b688-f2380ea088b7
...
begin
	...
	flux_bounds_array2[1,2] = 203.0*E[1]*11.9*96.7/((1+11.9)*(1+96.7)-1)
	flux_bounds_array2[2,2] = 34.5*E[2]*0.0915*0.0852/((1+0.0915)*(1+0.0852)-1)
	flux_bounds_array2[3,2] = 249.0*E[3]*0.165*1.39/((1+0.165)*(1+1.39)-1)
	flux_bounds_array2[4,2] = 88.1*E[4]*2.81*0.0119/((1+2.81)*(1+0.0119)-1)
	flux_bounds_array2[5,2] = 13.7*E[5]*73.1/((1+73.1)-1)
	flux_bounds_array2[6,2] = 13.7*E[6]*73.1/((1+73.1)-1)
	#Assume the other metabolites from pset 2 are all 1, and thus do not need to be factored in
...
# ╔═╡ 775dc13c-7508-46ea-a546-7f92268a2514
# check:
with_terminal() do
	...
	if (ef2 == 0.0 && sf2 == 4.0)
		println("Case 1: Optimal solution found. exit flag = $(ef2) and status flag = $(sf2)")
	else
		println("Case 1: Ooops! Check your problem setup. exit flag = $(ef2) and status flag = $(sf2)")
	end
end

# ╔═╡ 59c7cbf3-3937-47d0-8327-bff601c3455a
let
